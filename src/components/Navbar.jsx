...
const Navbar = () => {
  ...
  return (
    <nav className="w-full px-5 flex py-6 mt-2 justify-center items-center absolute top-0 left-0 z-10">
      <a href="/">
        <img
          src={logo}
          alt="drizzle"
      ...
      <div className="md:hidden flex flex-1 justify-end items-center">
        ...
        ${index === navLinks.length - 1 ? "mb-0" : "mb-4"} text-white`}
            ...
            <div className="items-center space-y-7 space-x-2">
              ...
              <button className="bg-[#7A62F9] hover:bg-[#7A62F9]/80 transition-colors rounded-lg text-white py-2 px-3 font-normal font-poppins">
                Get Started
              </button>
            </div>
          </ul>
